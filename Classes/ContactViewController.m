...
@synthesize homeButton, contactMainTable, contactTableController;
/*
...
- (void)viewDidLoad {
	...
	contactTableController = [[ContactTableController alloc] init];
	
	contactMainTable.delegate = contactTableController;
	contactMainTable.dataSource = contactTableController;
	
	contactMainTable.backgroundColor = [UIColor clearColor];
}
