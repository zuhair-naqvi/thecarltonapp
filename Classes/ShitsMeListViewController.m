...
#import "ShitsMeListViewController.h"
#import "ShitsMeListDetailViewController.h"

@implementation ShitsMeListViewController
...
- (void) initMenu
{
	...
	[dict dictionaryFromServer:@"shitsmelist/plist"];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	if([Children count] == 0) {
		...
		ShitsMeListDetailViewController *dvController = [[ShitsMeListDetailViewController alloc] initWithNibName:@"ShitsMeListDetailViewController" bundle:[NSBundle mainBundle]];
		...
		ShitsMeListViewController *rvController = [[ShitsMeListViewController alloc] initWithNibName:@"ShitsMeListViewControllerController" bundle:[NSBundle mainBundle]];
